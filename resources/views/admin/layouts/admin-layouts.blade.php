...
<head>
    ...
    <!-- BEGIN: Page Title-->
    <title>Analytics Home | Modern & Minimal Multipurpose Bootstrap Admin Dashboard</title>
    <!-- END:  Page Title-->
    <!-- BEGIN: Vendor CSS-->
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
                    ...
                    <div class="header-right">
                        <ul class="list-inline justify-content-end mb-0 d-flex align-items-center">
                            ...
                            <li class="list-inline-item dropdown hidden-xs">
                                <a class="dropdown-icon waves-effect" href="" role="button"
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <div class="row no-gutters header-service">
                                        ...
                                        <div class="col-md-6 bd-r bd-b">
                                            <a href="" class="tx-center d-block waves-effect waves-light">
                                                <img src="../../assets/images/icon/bill-reciept.png"
                                                    class="img-fluid wd-50" alt="">
                                                <h2 class="tx-15 mg-t-10 mb-0">Billing</h2>
                                        ...
                                        <div class="col-md-6 bd-b">
                                            <a href="" class="tx-center d-block waves-effect waves-light">
                                                <img src="../../assets/images/icon/finance.png"
                                                    class="img-fluid wd-50" alt="">
                                        ...
                                        <div class="col-md-6 bd-b">
                                            <a href="" class="tx-center d-block waves-effect waves-light">
                                                <img src="../../assets/images/icon/shipping.png"
                                                    class="img-fluid wd-50" alt="">
                            ...
                            <li class="list-inline-item dropdown hidden-xs">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <div class="top-notifications-area">
                                        ...
                                        <div
                                            class="notifications-footer d-flex justify-content-between align-items-center">
                                            <a href="">View all Notifications</a>
                                            <a href="" class="tooltip-primary" data-toggle="tooltip"
                                                data-placement="left" title=""
                                                data-original-title="Notifications Settings"><i
                                    ...
                                    <div class="top-message-area">
                                        ...
                                        <div class="message-box" id="messageBox">
                                            ...
                                            <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                                <div class="pd-r-10 d-flex align-items-center justify-content-center">
                                                    <span class="avatar avatar-online">
                                                        <img src="../../assets/images/users-face/2.png"
                                                            class="img-fluid" alt="">
                                                        <i></i>
                                                    </span>
                                                </div>
                                            ...
                                            <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                                <div class="pd-r-10 d-flex align-items-center justify-content-center">
                                                    <span class="avatar avatar-busy">
                                                        <img src="../../assets/images/users-face/3.png"
                                                            class="img-fluid" alt="">
                                                        <i></i>
                                                    </span>
                                                </div>
                                            ...
                                            <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                                <div class="pd-r-10 d-flex align-items-center justify-content-center">
                                                    <span class="avatar avatar-busy">
                                                        <img src="../../assets/images/users-face/4.png"
                                                            class="img-fluid" alt="">
                                                        <i></i>
                                                    </span>
                                                </div>
                                            ...
                                            <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                                <div class="pd-r-10 d-flex align-items-center justify-content-center">
                                                    <span class="avatar avatar-offline">
                                                        <img src="../../assets/images/users-face/5.png"
                                                            class="img-fluid" alt="">
                                                        <i></i>
                                                    </span>
                                                </div>
                                            ...
                                            <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                                <div class="pd-r-10 d-flex align-items-center justify-content-center">
                                                    <span class="avatar avatar-offline">
                                                        <img src="../../assets/images/users-face/6.png"
                                                            class="img-fluid" alt="">
                                                        <i></i>
                                                    </span>
                                                </div>
                                        ...
                                        <div
                                            class="top-message-footer d-flex justify-content-between align-items-center">
                                            <a href="">View all Messages</a>
                                            <a href="" class="tooltip-primary" data-toggle="tooltip"
                                                data-placement="left" title=""
                                                data-original-title="Messages Settings"><i data-feather="settings"
                            ...
                            <li class="list-inline-item dropdown ml-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-profile">
                                    <div class="user-profile-area">
                                        ...
                                        <a href="{{route('admin.logout')}}" class="dropdown-item d-flex align-items-center"><span
            ...
            <footer class="page-footer d-block d-sm-flex justify-content-between pd-x-30 pd-t-20 pd-b-15">
                <p class="mg-b-15 mg-sm-b-0">Copyright&copy; {{date("Y")}} |  By <a href="https://arman.cyou"
                        target="_blank">ArmStrong BD</a></p>
    ...
    <div class="settingSidebar">
        <a href="javascript:void(0)" class="settingPanelToggle tooltip-primary" data-toggle="tooltip"
            data-trigger="hover" data-placement="left" title="" data-original-title="Theme Customizer">
