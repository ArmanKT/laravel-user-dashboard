            ...
            <div class="d-flex hidden-xs">
                <a href="{{ route('admin.roles.index') }}" target=""
                    class="btn bg-soft-primary mr-3 e d-md-block pd-y-8-force waves-effect"><span data-feather="life-buoy"
                        class="wd-16 ht-16 mr-1"></span>All Roles</a>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h6 class="mb-0">Edit this role</h6>
                    ...
                    <div class="container ">
                        <form class="m-3" action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                            @method('PUT')
                            @csrf
                                ...
                                <div class="container">
                                    <div class="row"> <label class="switch">
                                            <input type="checkbox" id="checkPermissionAll" value="1"
                                                {{ roleHasPermissions($role, $all_permissions) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-3">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" id="{{ $i }}Management"
                                                    ...
                                                    {{ roleHasPermissions($role, $permissions) ? 'checked' : '' }}>
